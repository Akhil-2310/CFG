  ...
  return (
    <div class="container px-5 py-24 mx-auto" style={{"font-family":"'Quicksand', sans-serif"}}>
      <div class="flex flex-col text-center w-full mb-20">
        <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900" style={{"font-family":"'Quicksand', sans-serif", "font-weight":"bold"}}>
          My Inventory
        </h1>
          ...
          <thead>
            <tr class="grid grid-cols-3 gap-4">
              <th class=" d-flex justify-content-center px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl" >
                <h3 style={{"font-family":"'Quicksand', sans-serif", "font-weight":"bold"}}>Name</h3>
              </th>
      ...
      <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900" style={{"font-family":"'Quicksand', sans-serif", "font-weight":"bold"}}>Add New Item</h1>

         <form class="p-10 border" style={{"font-family":"'Quicksand', sans-serif",  "font-size":22}}>
        ...
        {options.map(option => (
          <option key={option.value} value={option.value}>
            ...
            <button type="submit" class="btn mt-5" onClick={handleSubmit} style={{ backgroundColor: "rgb(79, 90, 132)", color: "white" , width:150}}> Submit </button>
        </form>
    </div>
  );
}
